...
```{r}
#change location as necess
write.table(rbind(analysis.1$greater), file = paste('/Volumes/Documents-1/R_onAir/EGF_gage analysis/tests/',filename.desc[1],'.xls',collapse=T), sep ="\t") 
```
