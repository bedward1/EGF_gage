...
# to select essential genes in group
analysis.esg.up <- esset.grp(analysis.1$greater, data.G1, gsets=path.lib, ref = ans.ref, samp = ans.samp, output = F,make.plot = F, compare= ans.compare, test4up= T, samedir=ans.same.dir, use.fold=ans.use.fold)
