...
# input is from gage_step1.Rmd
setwd('/Volumes/Documents-1/R_onAir/EGF_gage analysis/graphs/high_dens/')
ans.path.ids = c(analysis.esg.greater$essentialSets[[1]],analysis.esg.greater$essentialSets[[2]],analysis.esg.greater$essentialSets[[3]])
